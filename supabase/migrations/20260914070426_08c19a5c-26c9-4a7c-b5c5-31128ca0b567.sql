...
('projects', $json${"items": [
  ...
  {"slug":"riverside-district-plan","name":"Rangpur City Centre","location":"Narayanganj","category":"Master Planning","year":"2025","area":"46 acres","description":"A mixed-use district framework balancing housing density, public green space and a restored waterfront edge.","overview":"The plan sets a walkable block structure with a continuous public edge along the water. Density is concentrated inland, freeing the riverfront for parkland, flood buffering and civic amenity.","services":"Master Planning, Real Estate Development"},
  {"slug":"terrace-gardens-mixed-use","name":"Kazi Heights","location":"Purbachal, Dhaka","category":"Commercial","year":"2026","area":"520,000 sq ft","description":"A stepped mixed-use development where every level carries planted terraces, softening the mass against the city skyline.","overview":"Kazi Heights layers retail, workspace and homes into a cascading section. Planted terraces shade the floor below, collect rainwater, and give every unit outdoor space — a dense building that still reads as landscape.","services":"Architecture, Real Estate Development, Project Management, Construction Solutions"}
]}$json$::jsonb);
